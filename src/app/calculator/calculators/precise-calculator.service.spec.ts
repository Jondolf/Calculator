...
fdescribe('Service: PreciseCalculator', () => {
  let service: PreciseCalculatorService;

  beforeEach(() => {
    service = new PreciseCalculatorService();
    TestBed.configureTestingModule({
      providers: [PreciseCalculatorService]
    });
  });

  it('should ...', inject([PreciseCalculatorService], (calcService: PreciseCalculatorService) => {
